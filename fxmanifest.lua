...
data_file 'AUDIO_SYNTHDATA' 'audioconfig/r34sound_amp.dat'
...
data_file 'AUDIO_SYNTHDATA' 'audioconfig/ecoboostv6_amp.dat'
...
data_file 'AUDIO_SYNTHDATA' 'audioconfig/mclarenv8_amp.dat'
...
data_file 'AUDIO_SYNTHDATA' 'audioconfig/s15sound_amp.dat'
...
data_file 'AUDIO_GAMEDATA' 'audioconfig/hachurac_game.dat'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/hachurac_sounds.dat'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_hachurac'
